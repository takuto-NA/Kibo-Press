// 責務: business-report をベースに、見出しレベル 1〜3 の文字サイズだけ大きくした比較用テンプレ
...
// ガード: business-report より見出しを大きくする（Typst テンプレ編集の差分確認用）
#show heading.where(level: 1): it => block(
  above: 1.2em,
  below: 0.6em,
)[
  #set text(size: 20pt, weight: "bold", font: ("$mainfont$",))
  #it
]
#show heading.where(level: 2): it => block(
  ...
  #set text(size: 15pt, weight: "bold", font: ("$mainfont$",))
  #it
]
